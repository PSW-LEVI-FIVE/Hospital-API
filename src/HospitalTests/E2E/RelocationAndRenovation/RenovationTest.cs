...
public class RenovationTest
{
    ...
    public void Test_renovation()
    {
        ...
        Thread.Sleep(1000);
        element = Driver.FindElement(By.Id("mat-tab-label-0-2"));
        Thread.Sleep(1000);
        element.Click();
        Actions _action = new Actions(Driver);
        element = Driver.FindElement(By.Id("renovation-1"));
    ...
    public void Test_renovation_1()
    {
        ...
        element.Click();
        Actions _action = new Actions(Driver);
        element = Driver.FindElement(By.Id("renovation-2"));
        _action.MoveToElement(element).Click().Perform();
        Thread.Sleep(1000);
        Assert.Pass();
