...
namespace HospitalLibrary.Renovation
{
    public class RenovationService: IRenovationService
    {
        ...
        Task<List<Renovations.Model.Renovation>> IRenovationService.GetAllPending()
        {
            throw new NotImplementedException();
        }

        public async Task<Renovations.Model.Renovation> Create(Renovations.Model.Renovation renovation)
        {
            //validate renovation
        ...
        public Task ExecuteRenovation(Renovations.Model.Renovation renovation)
        {
            throw new NotImplementedException();
        }
       ...
       /* private async Task<List<TimeInterval>> GetAllEarliestForDate(DateTime date,int roomId)
        ...
        public void Update(Renovations.Model.Renovation renovation)
        {
            //validate renovation
        ...
        public Task<List<TimeInterval>> GenerateTimeSlots(TimeInterval timeInterval, int duration, int roomid)
        {
            throw new NotImplementedException();
        }

        public Task<List<TimeInterval>> GenerateCleanerTimeSlots(TimeInterval timeInterval, int duration, int roomid)
        {
            throw new NotImplementedException();
        }

        public async Task<List<Renovations.Model.Renovation>> GetAllPending()
        {
