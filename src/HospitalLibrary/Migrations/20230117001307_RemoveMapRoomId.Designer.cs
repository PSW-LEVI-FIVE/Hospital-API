...
namespace HospitalLibrary.Migrations
{
    ...
    [Migration("20230117001307_RemoveMapRoomId")]
    partial class RemoveMapRoomId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalLibrary.Map.MapRoom", b =>
                {
                    ...
                    b.Property<string>("SecondaryCoordinatesList")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("HospitalLibrary.Infrastructure.EventSourcing.Events.RenovationDomainEvent", b =>
                {
                    b.HasBaseType("HospitalLibrary.Infrastructure.EventSourcing.DomainEvent");
                    ...
                    b.ToTable("RenovationDomainEvent");
                });

            modelBuilder.Entity("HospitalLibrary.Infrastructure.EventSourcing.Events.SchedulingAppointmentDomainEvent", b =>
                {
                    b.HasBaseType("HospitalLibrary.Infrastructure.EventSourcing.DomainEvent");
            ...
            modelBuilder.Entity("HospitalLibrary.Infrastructure.EventSourcing.DomainEvent", b =>
                {
                    ...
                    b.HasOne("HospitalLibrary.Renovations.Model.Renovation", null)
                        .WithMany("Changes")
                    ...
                    b.OwnsOne("HospitalLibrary.Shared.Model.ValueObjects.Coordinates", "Coordinates", b1 =>
                        {
                            ...
                            b1.HasKey("MapRoomRoomId");

                            b1.ToTable("MapRooms");

                            b1.WithOwner()
                                .HasForeignKey("MapRoomRoomId");
                        });
            ...
            modelBuilder.Entity("HospitalLibrary.Infrastructure.EventSourcing.Events.RenovationDomainEvent", b =>
                {
                    b.HasOne("HospitalLibrary.Infrastructure.EventSourcing.DomainEvent", null)
                        .WithOne()
                        .HasForeignKey("HospitalLibrary.Infrastructure.EventSourcing.Events.RenovationDomainEvent", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("HospitalLibrary.Infrastructure.EventSourcing.Events.SchedulingAppointmentDomainEvent", b =>
                {
                    b.HasOne("HospitalLibrary.Infrastructure.EventSourcing.DomainEvent", null)
                        .WithOne()
                        .HasForeignKey("HospitalLibrary.Infrastructure.EventSourcing.Events.SchedulingAppointmentDomainEvent", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
